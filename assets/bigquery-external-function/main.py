...
def gcs_copy():
    try:
        DESTINATION_BUCKET_ID = "gcp-lakehouse-edw-export-" + os.environ.get(
            "PROJECT_ID"
        )  # os.environ.get("DESTINATION_BUCKET_ID")
...
def create_gcp_view_ecommerce():
    try:
        ...
        sql = """
            ...
            u.age user_age, u.gender user_gender, u.state user_state,  u.postal_code user_postal_code, u.city user_city, u.country user_country,
            u.latitude user_lat, u.longitude user_long,
